// Version 1.0.0.0.
var module = angular.module("DlhSoft.ProjectData.PertChart.Directives", []);
dsDefinePDPCDirective(module, "PertChart");
dsDefinePDPCDirective(module, "NetworkDiagram");
function dsDefinePDPCDirective(module, directiveName, controlName) {
        ...
        return {
            ...
            link: function (scope, element) {
                ...
                var initialization = function () {
                    ...
                    DlhSoft.Controls.Pert[controlName ? controlName : directiveName + "View"].initialize(controlElement, items, settings, license);
                    if (scope.change) {
